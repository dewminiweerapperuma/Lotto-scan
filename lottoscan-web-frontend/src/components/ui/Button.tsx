...
const VARIANTS = {
  ...
  outline: "bg-white text-text-primary border border-border-default hover:border-border-hover shadow-sm hover:shadow active:scale-95",
...
export default function Button({ children, onClick, variant = "primary", size = "md", disabled, loading, fullWidth, type = "button", className = "", title }: ButtonProps) {
  return (
